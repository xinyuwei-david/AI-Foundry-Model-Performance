...
ENDPOINT = input("Please enter the Azure AI endpoint URL: ").strip()  
...
def main():  
    ...
    """  
    concurrency_levels = [200, 300]  # Test concurrency levels  
    prompt_lengths = [128, 256, 512, 1024, 2048, 4096]  # Test different input sizes  
    total_requests_each = [10, 20, 30, 40, 50]  # Adjust as needed  
